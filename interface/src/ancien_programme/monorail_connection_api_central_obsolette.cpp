...
{	
	...
	ros::NodeHandle n; // creation du noeud
        ros::Rate loop_rate(0.5); // frequence de la boucle
...
j=100;
  ...
  //-------------------------------------------------------------------------------------------
	...
	if(modbus_write_register(api_central,151,1) == 1)
		cout<<"ecriture reussie"<<endl;
	else cout<<"ecriture ECHOUER"<<endl;
	/*if(modbus_write_register(api_central,150,(bool)0) == 1)
		cout<<"ecriture A1_1 a 0 reussie"<<endl;
	else cout<<"ecriture A1_1 a 0 ECHOUER"<<endl;*/
